...
def generate_launch_description():
    pkg_share = get_package_share_directory('6dof_package')
    urdf_path = os.path.join(pkg_share, 'urdf', 'robot_6dof.urdf')
    ...
    return LaunchDescription([jsp, rsp, static_tf, rviz])
